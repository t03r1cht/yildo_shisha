...
public class CustomExpendableAdapterShishas extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        final String getraenke_name = ((Product) getChild(groupPosition, childPosition)).getName();
        final Double getraenke_preis = ((Product) getChild(groupPosition, childPosition)).getPreis();
        ...
        TextView txtListChild = (TextView) convertView
                .findViewById(R.id.prod_name_tv);
        TextView txtListChild2 = (TextView) convertView.findViewById(R.id.prod_preis_tv);
